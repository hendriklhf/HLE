...
namespace Sterbehilfe.Strings
{
    ...
    public static class StringHelper
    {
        ...
        /// <summary>
        /// Decodes a <see cref="byte"/> array to a <see cref="string"/>.
        /// </summary>
        ...
        /// The last part of the input <see cref="string"/> <paramref name="str"/> will be added to the <see cref="List{String}"/> even if it doesn't reach the given amount <paramref name="charCount"/>.
        /// </summary>
