...
public static partial class SpanHelpers<T>
{
    private readonly ref struct AlignmentResult
    {
        ...
        public AlignmentResult(ref byte source, ref byte destination, nuint byteCount)
        {
            _source = ref source;
